...
namespace pnetc
{
  namespace op
  {
    namespace singular_template
    {
      ...
      {
#line 429 "/home/atraore/gpi/try_gpi/gspc-gromovwitten/template/workflow/template.xpnet"

std::cout << "starting Quasimodular" << std::endl;
  std::vector<fmpq_t*> Iq = RESOLVE_INTERFACE_FUNCTION( stringToVectorFmpq) (answer);
std::cout << "Iq: " << answer << std::endl;
    // Maximum weight
