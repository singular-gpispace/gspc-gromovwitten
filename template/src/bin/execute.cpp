...
namespace template_module
{
  ...
  {
    std::cout << "In execute file***:: Starting execute function." << std::endl;
    singular_template::installation installation_obj;
    std::cout << "In execute file***:: Installation object created." << std::endl;
    gspc::installation const installation
    (installation_obj.gspc_installation(parameters));
    std::cout << "In execute file*** :: GSPC installation initialized." << std::endl;
    gspc::scoped_rifds rifds(gspc::rifd::strategy{ parameters },
      gspc::rifd::hostnames{ parameters },
      gspc::rifd::port{ parameters },
      installation);

    std::cout << "In execute file***:: Scoped RIFDs initialized." << std::endl;
    ...
    std::cout << " In execute file***:: Workflow object created." << std::endl;
